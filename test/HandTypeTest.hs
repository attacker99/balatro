...
spec = do
    describe "Basic Hand Types" $ do
        ...
        it "detects three of a kind with quantity" $ do
            getHandType [NormalCard Two Spade 3 None Base NoneS] 5 1 `shouldBe` ThreeKind

        it "detects three of a kind wilds" $ do
            getHandType [NormalCard Two Spade 2 Wild Base NoneS, NormalCard Two Heart 1 None Base NoneS] 5 1 `shouldBe` ThreeKind
        ...
        it "detects five of a kind with quantity" $ do
            getHandType [NormalCard Two Spade 5 None Base NoneS] 5 1 `shouldBe` FlushFive

        it "detects five of a kind with wilds" $ do
            getHandType [NormalCard Two Spade 3 Wild Base NoneS, NormalCard Two Heart 2 None Base NoneS] 5 1 `shouldBe` FlushFive

        it "detects five of a kind with mixed wilds and quantity" $ do
            getHandType [NormalCard Two Spade 3 None Base NoneS, NormalCard Two Heart 1 Wild Base NoneS, NormalCard Two Diamond 1 Wild Base NoneS] 5 1 `shouldBe` FlushFive

        it "detects four of a kind with quantity" $ do
            getHandType [NormalCard Two Spade 4 None Base NoneS, mkBaseCard Three Heart] 5 1 `shouldBe` FourKind

        it "detects four of a kind with wilds" $ do
            getHandType [NormalCard Two Spade 2 Wild Base NoneS, NormalCard Two Heart 2 None Base NoneS, mkBaseCard Three Heart] 5 1 `shouldBe` FourKind

        it "detects four of a kind with mixed wilds and quantity" $ do
            getHandType [NormalCard Two Spade 2 None Base NoneS, NormalCard Two Heart 1 Wild Base NoneS, NormalCard Two Diamond 1 Wild Base NoneS, mkBaseCard Three Heart] 5 1 `shouldBe` FourKind
        ...
        it "detects full house" $ do
            getHandType [NormalCard Two Spade 2 None Base NoneS, NormalCard Three Heart 1 None Base NoneS, NormalCard Three Diamond 1 None Base NoneS, NormalCard Two Club 1 None Base NoneS] 5 1 `shouldBe` FullHouse
        ...
        it "detects flush five" $ do
            getHandType [NormalCard Two Heart 4 None Base NoneS, mkBaseCard Two Spade] 4 1 `shouldBe` FlushFive

        it "detects flush five with quantity" $ do
            getHandType [NormalCard Two Heart 5 None Base NoneS] 5 1 `shouldBe` FlushFive

        it "detects flush five with wilds" $ do
            getHandType [NormalCard Two Heart 3 Wild Base NoneS, NormalCard Two Heart 2 None Base NoneS] 5 1 `shouldBe` FlushFive

        it "detects flush five with mixed wilds and quantity" $ do
            getHandType [NormalCard Two Heart 3 None Base NoneS, NormalCard Two Heart 1 Wild Base NoneS, NormalCard Two Heart 1 Wild Base NoneS] 5 1 `shouldBe` FlushFive
    ...
    describe "4-Card Hands" $ do
        ...
        it "detects 4-card straight flush" $ do
            let cards = [mkBaseCard King Spade, mkBaseCard Queen Spade, mkBaseCard Ace Spade, mkBaseCard Jack Heart, NormalCard Four Spade 1 None Base NoneS]
            getHandType cards 4 2 `shouldBe` StraightFlush

        it "detects 4-card straight flush with distance 2" $ do
            let cards = [mkBaseCard Two Spade, mkBaseCard Six Diamond, mkBaseCard Ten Diamond, mkBaseCard King Spade, mkBaseCard Ace Spade, mkBaseCard Jack Heart, NormalCard Four Spade 1 None Base NoneS]
            getHandType cards 4 2 `shouldBe` StraightFlush
    ...
    describe "Special Cases" $ do
        describe "flush house" $ do
            it "detects flush house with fs_sz = 4" $ do
                let hand = [NormalCard Ace Spade 1 None Base NoneS, NormalCard Ace Spade 1 None Base NoneS, NormalCard Ace Diamond 1 None Base NoneS, NormalCard King Spade 1 None Base NoneS, NormalCard King Spade 1 None Base NoneS]
                getHandType hand 4 1 `shouldBe` FlushHouse

            it "detects flush house with fs_sz = 4" $ do
                let hand = [NormalCard Ace Spade 2 None Base NoneS, NormalCard King Spade 2 None Base NoneS, mkBaseCard Ace Diamond]
                getHandType hand 4 1 `shouldBe` FlushHouse

            it "detects flush house with 1 Wild cards" $ do
                let hand = [NormalCard Ace Spade 1 None Base NoneS, NormalCard Ace Spade 1 None Base NoneS, NormalCard Ace Spade 1 None Base NoneS, NormalCard King Spade 1 None Base NoneS, NormalCard King Diamond 1 Wild Base NoneS]
        ...
        describe "straight flush with 1 Wild NormalCards" $ do
            it "detects 5-NormalCard straight flush with 1 wild" $ do
                let hand = [NormalCard Six Spade 1 None Base NoneS, NormalCard Seven Spade 1 None Base NoneS, NormalCard Eight Spade 1 None Base NoneS, NormalCard Nine Spade 1 None Base NoneS, NormalCard Ten Diamond 1 Wild Base NoneS]
                getHandType hand 5 1 `shouldBe` StraightFlush

            it "detects 4-NormalCard straight flush with 1 wild" $ do
                let hand = [NormalCard Six Heart 1 None Base NoneS, NormalCard Seven Heart 1 None Base NoneS, NormalCard Eight Heart 1 None Base NoneS, NormalCard Nine Heart 1 Wild Base NoneS]
                getHandType hand 4 1 `shouldBe` StraightFlush

            it "detects 5-NormalCard straight flush with 2 wild" $ do
                let hand = [NormalCard Six Spade 1 None Base NoneS, NormalCard Seven Spade 1 None Base NoneS, NormalCard Eight Spade 1 None Base NoneS, NormalCard Nine Spade 1 Wild Base NoneS, NormalCard Ten Spade 1 Wild Base NoneS]
                getHandType hand 5 2 `shouldBe` StraightFlush

            it "detects 4-NormalCard straight flush with 2 wild" $ do
                let hand = [NormalCard Six Heart 1 None Base NoneS, NormalCard Seven Heart 1 None Base NoneS, NormalCard Eight Heart 1 Wild Base NoneS, NormalCard Nine Heart 1 Wild Base NoneS]
                getHandType hand 4 2 `shouldBe` StraightFlush

        describe "normal straight/straight flush" $ do
            it "detects 5-NormalCard straight flush with 2 wild" $ do
                let hand = [NormalCard Five Spade 1 None Base NoneS, NormalCard Seven Spade 1 None Base NoneS, NormalCard Eight Spade 1 None Base NoneS, NormalCard Ten Diamond 1 Wild Base NoneS, NormalCard Queen Diamond 1 Wild Base NoneS]
                getHandType hand 5 2 `shouldBe` StraightFlush

            it "detects 4-NormalCard straight flush with 2 wild" $ do
                let hand = [NormalCard Three Heart 1 None Base NoneS, NormalCard Nine Heart 1 None Base NoneS, NormalCard Five Heart 1 Wild Base NoneS, NormalCard Queen Spade 1 Wild Base NoneS, NormalCard Seven Spade 1 None Base NoneS]
                getHandType hand 4 2 `shouldBe` StraightFlush

            it "detects 4-NormalCard ace-low straight flush with 2 wild" $ do
                let hand = [NormalCard Three Heart 1 None Base NoneS, NormalCard Ace Heart 1 None Base NoneS, NormalCard Five Heart 1 Wild Base NoneS, NormalCard Queen Spade 1 Wild Base NoneS, NormalCard Seven Spade 1 None Base NoneS]
                getHandType hand 4 2 `shouldBe` StraightFlush

            it "detects 5-NormalCard straight with 2 wild" $ do
                let hand = [NormalCard Five Spade 1 None Base NoneS, NormalCard Seven Club 1 None Base NoneS, NormalCard Eight Spade 1 None Base NoneS, NormalCard Nine Spade 1 Wild Base NoneS, NormalCard Jack Diamond 1 Wild Base NoneS]
                getHandType hand 5 2 `shouldBe` Straight

            it "detects 4-NormalCard straight with 2 wild" $ do
                let hand = [NormalCard Eight Heart 1 None Base NoneS, NormalCard Ten Spade 1 None Base NoneS, NormalCard Queen Heart 1 Wild Base NoneS, NormalCard Ace Heart 1 Wild Base NoneS]
        ...
        it "detects five of a kind with 3 non-wilds of one rank and 2 non-wilds of another (same suit)" $ do
            let hand = [NormalCard Ace Heart 3 None Base NoneS, NormalCard King Heart 2 None Base NoneS]
            getHandType hand 5 1 `shouldBe` FlushHouse

        it "detects five of a kind with 3 non-wilds of one rank and 2 non-wilds of another (same suit)" $ do
            let hand = [NormalCard Ace Heart 3 None Base NoneS, NormalCard King Heart 1 None Base NoneS, mkBaseCard King Diamond]
            getHandType hand 4 1 `shouldBe` FlushHouse
        ...
        it "detects five of a kind with 5 cards of the same rank" $ do
            let hand = [NormalCard Ace Heart 4 None Base NoneS, mkBaseCard Ace Diamond]
        ...
        it "detects full house with 3 cards of one rank and 2 cards of another rank, mixed suits" $ do
            let hand = [NormalCard Ace Heart 3 None Base NoneS, NormalCard King Diamond 2 None Base NoneS]
            getHandType hand 5 1 `shouldBe` FullHouse

        it "detects full house with 3 cards of one rank and 2 cards of another rank, all different suits" $ do
            let hand = [NormalCard Ten Heart 3 None Base NoneS, NormalCard Nine Diamond 2 None Base NoneS]
            getHandType hand 5 1 `shouldBe` FullHouse
